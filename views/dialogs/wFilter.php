<?php
// views/dialogs/wFilter.php: Template placeholder for missing template coverage. VDEMO
	// Loading direct helper to read skins data
	CI()->load->helper(['direct']);
	mwSkin()->loadSheet('', 'mw.windows');
	mwSkin()->loadSheet('', 'mw.forms');
?>
<div class="winHeader">Combo Dialog TEST</div>

<ul class="winTabs">
	<li rel="content" hint="Single content">General</li>
	<li rel="row" hint="Single row">SEO</li>
	<li rel="forms" hint="Dialogs stacking">Socials</li>
	<li rel="combo1" hint="Contents stacking">Access</li>
	<li rel="combo2" hint="Rows stacking">Publishing</li>
	<li rel="combo3" hint="Content and Row">Combo 3 remove</li>
	<li rel="combo4" hint="Thinpads stacking">Combo 4 remove</li>
</ul>
